...
\begin{tabularx}{1\textwidth}{| l | l | X |}
  ...
  $x.add\_edge(lit_v, it_{v1})$ & P\textless local\_out\_edge\_iterator, bool\textgreater & adds an edge between vertices pointed to by $lit_v$ and $it_{v1}$ and returns, whether the edge has been added \\ \hline
...
\begin{tabularx}{1\textwidth}{| l | X | X |}
  ...
  $x.add\_edge(lit_v, it_{v1}$) & $it_{v1}$ and $lit_v$ point to valid vertices in X & returned index identifies constructed edge in global index space \\ \hline
