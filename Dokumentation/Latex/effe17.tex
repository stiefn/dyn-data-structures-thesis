...
\begin{tabularx}{1\textwidth}{| l | l | X |}
  ...
  \endhead
  \hline
  $X(n_v, it_1, it_2)$ &  & constructs the graph holding $n_v$ vertices and std::distance($it_1$, $it_2$) edges given by the iterators $i_1$ and $i_2$ of an edge list container\\ \hline
  $x.operator[](it_v)$ & vertex\_type & vertex identified by $it_v$ \\ \hline
  $x.operator[](lit_v)$ & vertex\_type & vertex identified by $lit_v$ \\ \hline
  $x.operator[](it_e)$ & edge\_type & edge identified by $it_e$ \\ \hline
  $x.operator[](lit_e)$ & edge\_type & edge identified by $lit_e$ \\ \hline
  ...
  $x[lit_v].out\_edges().begin()$ & local\_out\_edge\_iterator & iterator pointing to the first element in the edge-list of the vertex pointed to by $lit_v$ \\ \hline
  $x[lit_v].out\_edges().end()$ & local\_out\_edge\_iterator & iterator pointing past the last element in the edge-list of the vertex pointed to by $lit_v$ \\ \hline
\end{tabularx}
...
\begin{tabularx}{1\textwidth}{| l | X | X |}
  ...
  $x[lit_v].out\_edges().begin()$ & & \\ \hline
  $x[lit_v].out\_edges().end()$ & & \\ \hline
\end{tabularx}
...
\item $it_v$, $it_{v1}$ and $it_{v2}$, values of type \texttt{X::global\_vertex\_iterator}
...
\begin{tabularx}{1\textwidth}{| l | l | X |}
  ...
  $x.add\_vertex()$ & global\_vertex\_iterator & adds a vertex \\ \hline
  ...
  $x.add\_edge(it_{v1}, it_{v2})$ & global\_out\_edge\_iterator & adds an edge between vertices pointed to by $it_{v1}$ and $it_{v2}$ \\ \hline
  $x.add\_edge(lit_{v1}, lit_{v2})$ & global\_out\_edge\_iterator & adds an edge between vertices pointed to by $lit_{v1}$ and $lit_{v2}$ \\ \hline
...
\begin{tabularx}{1\textwidth}{| l | X | X |}
  ...
  $x.add\_edge(it_{v1}, it_{v2})$ & $it_{v1}$ and $it_{v2}$ point to valid vertices in X & returned index identifies constructed edge in global index space \\ \hline
...
\item $x$, a value of type X
\item $n_v$, a value of type \texttt{X::vertex\_size\_type}
\item $it_1$ and $it_2$, \texttt{InputIterators} with a valid range $[i_1, i_2]$ referring to elements of type \texttt{TP<std::pair<int, VT>, P<int, VT>, ET>}
\item $it_v$, a value of type \texttt{X::global\_vertex\_iterator}
\item $lit_v$, a value of type \texttt{X::local\_vertex\_iterator}
\item $it_e$, a value of type \texttt{X::global\_out\_edge\_iterator}
\item $lit_e$, a value of type \texttt{X::local\_out\_edge\_iterator}
...
\begin{tabularx}{1\textwidth}{| l | l | X |}
  ...
  \hline
  $X(n_v, it_1, it_2)$ &  & constructs the graph holding $n_v$ vertices and std::distance($it_1$, $it_2$) edges given by the iterators $i_1$ and $i_2$ of an edge list container\\ \hline
  $x.set\_attribute(it_v, a_v)$ &  & replaces the attributes of the vertex pointed to by $it_v$ with a copy of $a_v$\\ \hline
  $x.set\_attribute(lit_v, a_v)$ &  & replaces the attributes of the vertex pointed to by $lit_v$ with a copy of $a_v$\\ \hline
  $x.set\_attribute(it_e, a_e)$ &  & replaces the attributes of the vertex pointed to by $it_e$ with a copy of $a_e$\\ \hline
  $x.set\_attribute(lit_e, a_e)$ &  & replaces the attributes of the vertex pointed to by $lit_e$ with a copy of $a_e$\\ \hline
\end{tabularx}
...
\begin{tabularx}{1\textwidth}{| l | X | X |}
  ...
  $x.set\_attribute(it_v, a_v)$ & $it_v$ points to a valid vertex in X & \\ \hline
  $x.set\_attribute(lit_v, a_v)$ & $lit_v$ points to a valid vertex in X & \\ \hline
  $x.set\_attribute(it_e, a_e)$ & $it_e$ points to a valid edge in X & \\ \hline
  $x.set\_attribute(lit_e, a_e)$ & $lit_e$ points to a valid edge in X & \\ \hline
\end{tabularx}
...
\begin{tabularx}{1\textwidth}{| l | l | X |}
  ...
  $x[lit_v].in\_edges().begin()$ & local\_in\_edge\_iterator & iterator to the first inbound edge connected to the vertex pointed to by $lit_v$ \\ \hline
  $x[lit_v].in\_edges().end()$ & local\_in\_edge\_iterator & iterator past the last inbound edge connected to to the vertex pointed to by $lit_v$ \\ \hline
\end{tabularx}
...
\begin{tabularx}{1\textwidth}{| l | X | X |}
  ...
  $x[lit_v].in\_edges().begin()$ & $lit_v$ points to a valid vertex in X & \\ \hline
  $x[lit_v].in\_edges().end()$ & $lit_v$ points to a valid vertex in X & \\ \hline
\end{tabularx}
...
\begin{tabularx}{1\textwidth}{| l | l | X |}
  ...
  $x[lit_v].edges().begin()$ & local\_edge\_iterator & iterator to the first edge (inbound and outbound) connected to the vertex pointed to by $lit_v$ \\ \hline
  $x[lit_v].edges().end()$ & local\_edge\_iterator & iterator past the last edge (inbound and outbound) connected to to the vertex pointed to by $lit_v$ \\ \hline
\end{tabularx}
...
\begin{tabularx}{1\textwidth}{| l | X | X |}
  ...
  $x[lit_v].edges().begin()$ & $lit_v$ points to a valid vertex in X & \\ \hline
  $x[lit_v].edges().end()$ & $lit_v$ points to a valid vertex in X & \\ \hline
\end{tabularx}
