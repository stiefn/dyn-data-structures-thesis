...
typedef GlobHeapContigousMem<std::vector<int> g_mem;
GlobPtr<int, g_mem> ptr(mem, 0);     // position 0 in index space
++ptr;                               // go to position 1 in index space
auto ref = *ptr;                     // dereference pointer to GlobSharedRef object
